...
Below table was generated using integer partition test. It is trimmed version to show the interation grow speed depend on partition and set size. The full file generated by the script knapsack.py.
