  ...
  auto on(events::summary) -> void {
    if (static auto once = true; once) {
      ...
      if (tests_.fail or asserts_.fail) {
        printer_ << "\n========================================================"
                    "=======================\n"
                 << "BBSort_tests:   " << (tests_.pass + tests_.fail) << " | "
        ...
        std::cout << printer_.colors().pass << "All BBSort_tests passed"
                  << printer_.colors().none << " (" << asserts_.pass
                  << " asserts in " << tests_.pass << " BBSort_tests)\n";

        if (tests_.skip) {
          std::cout << tests_.skip << " BBSort_tests skipped\n";
        }
